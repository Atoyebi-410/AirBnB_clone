...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        """this is initialization of a BaseModel instance"""
        if (len(kwargs) == 0):
    ...
    def __str__(self):
        """this is the string representation of a BaseModel instance"""
    ...
    def save(self):
        """this updates 'updated_at' instance with current datetime"""
        self.updated_at = datetime.now()
        models.storage.save()

    def to_dict(self):
        """this returns dictionary representation of BaseModel class."""
