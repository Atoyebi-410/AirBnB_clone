...
class TestBase(unittest.TestCase):
    """
        this is for testing the base class model.
    """

    def setUp(self):
        """
            this is to initialize instance.
        """
    ...
    def TearDown(self):
        """
            this is removing instance.
        """
        del self.my_model

    def test_id_type(self):
        """
            this checks that the type of the id is string.
        """
        self.assertEqual("<class 'str'>", str(type(self.my_model.id)))

    def test_ids_differ(self):
        """
            this checks that the ids between two instances are different.
        """
        new_model = BaseModel()
    ...
    def test_save(self):
        """
            this checks that after updating the instance; the dates differ in the
    ...
    def test_str_overide(self):
        """
            this checks that the right message gets printed.
        """
        backup = sys.stdout
    ...
    def test_to_dict_type(self):
        """
            this checks that the to_dict method return type.
        """
    ...
    def test_to_dict_class(self):
        """
            this checks that the __class__ key exists.
        """
    ...
    def test_to_dict_type_updated_at(self):
        """
            this checks the type of the value of updated_at.
        """
    ...
    def test_to_dict_type_created_at(self):
        """
            this checks the type of the value of created_at.
        """
    ...
    def test_kwargs_instantiation(self):
        """
            this test that an instance is created using the
            key value pair.
        """
    ...
    def test_type_created_at(self):
        """
            this test that the new_model's updated_at
    ...
    def test_type_updated_at(self):
        """
            this test that the new_model's created_at
            data type is datetime.
        """
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(my_model_dict)
    ...
    def test_compare_dict(self):
        """
            this test that the new_model's and my_model's
