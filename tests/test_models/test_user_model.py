...
class TestUser(unittest.TestCase):
    ...
    def test_User_inheritance(self):
        '''
           this tests that the User class Inherits from BaseModel
        '''
        new_user = User()
    ...
    def test_User_attributes(self):
        '''
            This test the user attributes exist
        '''
    ...
    def test_type_last_name(self):
        '''
            This test the type of last_name
        '''
        new = User()
    ...
    def test_type_password(self):
        '''
            This tests the type of password
        '''
        new = User()
